...
read 'File' (1064,"demogor.lev") ":lib:demogor.lev";
read 'File' (1065,"dis.lev") ":lib:dis.lev";
read 'File' (1066,"geryon.lev") ":lib:geryon.lev";
read 'File' (1067,"yeenoghu.lev") ":lib:yeenoghu.lev";
