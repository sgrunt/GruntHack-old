 ...
 */
	...
	M2_WERE|M2_HOSTILE, M3_INFRAVISIBLE|M3_NOPOLY, CLR_BROWN),
	...
	M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_PNAME|M2_MALE, M3_INFRAVISIBLE|M3_NOPOLY,
	CLR_RED),
#endif
/*
 * eyes
 ...
 */
	...
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, CLR_RED),
 ...
 */
    MON("kobold", S_KOBOLD,
	LVL(3, 6, 10, 0, -2), (G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(400, 100, 0, MS_ORC, MZ_SMALL), MR_POISON, 0,
	M1_HUMANOID|M1_POIS|M1_OMNIVORE, M2_HOSTILE|M2_COLLECT|M2_KOBOLD,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
/*
 * leprechauns
 */
 ...
 */
	 ...
	 */
    MON("orc", S_ORC,
	LVL(3, 9, 10, 0, -3), (G_GENO|G_NOGEN|G_LGROUP),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, CLR_RED),
    MON("hill orc", S_ORC,
	LVL(4, 12, 10, 0, -4), (G_GENO|G_LGROUP|2),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(5, 6, 10, 0, -5), (G_GENO|G_LGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Uruk-hai", S_ORC,
	LVL(6, 8, 10, 0, -4), (G_GENO|G_LGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	M2_MINION|M2_STALK|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, CLR_WHITE),
    MON("ki-rin", S_ANGEL,
	...
	M1_FLY|M1_SEE_INVIS,
	M2_MINION|M2_STALK|M2_STRONG|M2_NASTY|M2_LORD,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, HI_GOLD),
    MON("Archon", S_ANGEL,
	...
	M2_MINION|M2_STALK|M2_STRONG|M2_NASTY|M2_LORD|
	  M2_COLLECT|M2_MAGIC,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, HI_LORD),
/*
 * Bats
 */
    MON("bat", S_BAT,
 ...
 */
	 ...
	 */
#define BABY_DRAGON_ATTACKS \
	 A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4), \
         ATTK(AT_BITE, AD_PHYS, 3, 8), \
	 NO_ATTK, NO_ATTK, NO_ATTK)
#define DRAGON_ATTACKS(a,b,c,d) \
          A(ATTK(a,b,c,d), \
	  ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4), \
	  ATTK(AT_BITE, AD_PHYS, 4, 8), ATTK(AT_ENGL, AD_DGST, 2, 10), \
	  NO_ATTK)
	...
	DRAGON_ATTACKS(AT_BREA, AD_MAGM, 4, 6), 
	...
	LVL(15, 9, -1, 20, 4), (G_GENO|1),
	DRAGON_ATTACKS(AT_BREA, AD_COLD, 4, 6), 
	...
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_OVIPAROUS|
	  M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_MAGIC,
	M3_DISPLACED, CLR_CYAN),
    MON("red dragon", S_DRAGON,
	LVL(15, 9, -1, 20, -4), (G_GENO|1),
	DRAGON_ATTACKS(AT_BREA, AD_FIRE, 6, 6), 
	...
	LVL(15, 9, -1, 20, 5), (G_GENO|1),
	DRAGON_ATTACKS(AT_BREA, AD_SLEE, 4,25), 
	...
	DRAGON_ATTACKS(AT_BREA, AD_DISN, 4,10), 
	...
	DRAGON_ATTACKS(AT_BREA, AD_ELEC, 4, 6), 
	...
	LVL(15, 9, -1, 20, 6), (G_GENO|1),
	DRAGON_ATTACKS(AT_BREA, AD_DRST, 4, 6), 
	...
	LVL(15, 9, -1, 20, 7), (G_GENO|1),
	DRAGON_ATTACKS(AT_BREA, AD_ACID, 4, 6), 
 ...
 */
    MON("gnome", S_GNOME,
	LVL(3, 6, 10, 4, 0), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(650, 100, 0, MS_ORC, MZ_SMALL), 0, 0,
	M1_HUMANOID|M1_OMNIVORE, M2_GNOME|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, CLR_BROWN),
#ifdef SPLITMON_1
};
#endif
#endif /* !SPLITMON_2 */
 ...
 */
    MON("giant", S_GIANT,
	LVL(3, 6, 0, 0, 2), (G_GENO|G_NOGEN|1),
	...
	LVL(3, 6, 0, 0, 2), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2,10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2250, 750, 0, MS_BOAST, MZ_HUGE), 0, 0,
	M1_HUMANOID|M1_CARNIVORE,
	...
	LVL(5, 10, 6, 0, -2), (G_GENO|G_SGROUP|1),
	...
	LVL(6, 12, 4, 5, 2), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2,10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(7, 12, 3, 10, -3), (G_NOHELL|G_GENO|G_SGROUP|1),
	...
	LVL(13, 12, 3, 10, -3), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 12),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT|M2_ETTIN,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
    MON("titan", S_GIANT,
	LVL(16, 18, -3, 70, 9), (1),
	...
	M2_STRONG|M2_ROCKTHROW|M2_NASTY|M2_PRINCE|M2_COLLECT|M2_MAGIC,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_MAGENTA),
 ...
 */
	...
	SIZ(1200, 100, 0, MS_MUMBLE, MZ_HUMAN),
	MR_COLD|MR_SLEEP|MR_POISON, MR_COLD,
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN|M1_TPORT,
	...
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN|M1_TPORT|M1_TPORT_CNTRL,
	M2_UNDEAD|M2_LORD|M2_HOSTILE|M2_MAGIC, M3_WANTSBOOK|M3_INFRAVISION, HI_LORD),
	...
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN|M1_TPORT|M1_TPORT_CNTRL,
	M2_UNDEAD|M2_PRINCE|M2_HOSTILE|M2_MAGIC, M3_WANTSBOOK|M3_INFRAVISION, HI_LORD),
/*
 * Mummies
 */
    MON("mummy", S_MUMMY,
	LVL(6, 12, 4, 30, -5), (G_GENO|G_NOCORPSE|3),
	A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_SILENT, MZ_HUMAN),
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE|M2_RACEMASK, M3_INFRAVISION, CLR_GRAY),
/*
 * Nagas
 */
 ...
 */
	...
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
	  ATTK(AT_BITE, AD_PHYS, 2, 5), ATTK(AT_GAZE, AD_CONF, 3, 4),
	  NO_ATTK, NO_ATTK),
 ...
 */
	...
	M2_RACEMASK|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY,
	M3_INFRAVISIBLE, CLR_RED),
	...
	SIZ(WT_HUMAN, 400, 0, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_RACEMASK|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_LORD|
	M2_MALE, M3_INFRAVISIBLE, CLR_BLUE),
	...
	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_RACEMASK|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_LORD|
	M2_MALE|M2_MAGIC, M3_INFRAVISIBLE, HI_ZAP),
    MON("Vlad the Impaler", S_VAMPIRE,
	LVL(28, 24, -6, 90, -10), (G_NOGEN|G_NOCORPSE|G_UNIQ),
	A(ATTK(AT_WEAP, AD_STUN, 6,  6), ATTK(AT_WEAP, AD_CONF, 6, 6), 
	  ATTK(AT_BITE, AD_DRLI, 1, 10), ATTK(AT_GAZE, AD_STUN, 2, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|
	  M2_NASTY|M2_PRINCE|M2_MALE|M2_HUMAN,
	M3_WAITFORU|M3_WANTSCAND|M3_INFRAVISIBLE|M3_NOPOLY, HI_LORD),
/*
 * Wraiths
 */
 ...
 */
    MON("zombie", S_ZOMBIE,
	LVL(4, 6, 8, 0, -3), (G_GENO|G_LGROUP|G_NOCORPSE|3),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 8),
	  ATTK(AT_BITE, AD_DRIN, 2, 1), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_SILENT, MZ_HUMAN),
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID,
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_RACEMASK, M3_INFRAVISION,
	CLR_BROWN),
    MON("ghoul", S_ZOMBIE,
...
/*
 * humans, elves, were-critters, and racial monsters
 */
    MON("human", S_HUMAN,
	...
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("wererat", S_HUMAN,
	LVL(2, 12, 10, 10, -7), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M2_WERE|M2_HOSTILE|M2_RACEMASK|M2_COLLECT, M3_INFRAVISIBLE|M3_NOPOLY,
	CLR_BROWN),
	...
	SIZ(WT_HUMAN, 400, 0, MS_WERE, MZ_HUMAN), MR_POISON, 0,
	M1_HUMANOID|M1_POIS|M1_REGEN|M1_OMNIVORE,
	M2_WERE|M2_HOSTILE|M2_RACEMASK|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_ORANGE),
    MON("shaman",   S_HUMAN, /* for the less intelligent */
	LVL(5, 12, 5, 10, -5), (1),
	A(ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_ORC, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_ORC|M2_KOBOLD|M2_ETTIN|M2_GREEDY|M2_JEWELS|M2_MAGIC,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_ZAP),
    MON("mage",   S_HUMAN,   /* for the more intelligent */
	LVL(5, 12, 5, 10, -5), (1),
	A(ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_ORC, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_GNOME|M2_GIANT|M2_OGRE|M2_MAGIC,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_ZAP),
    MON("lord", S_HUMAN,
	LVL(7, 14, 10, 10, 5), (2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_TUNNEL|M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_ELF|M2_GNOME|M2_ORC|M2_KOBOLD|M2_OGRE|
	...
	M1_TUNNEL|M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_ELF|M2_GNOME|M2_ORC|M2_KOBOLD|M2_OGRE|
	M2_STRONG|M2_LORD|M2_FEMALE|M2_GREEDY|M2_JEWELS|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BLUE),
    MON("king", S_HUMAN,
	LVL(9, 16, 10, 20, 6), (1),
	...
	M2_ELF|M2_STRONG|M2_COLLECT, M3_INFRAVISION|M3_INFRAVISIBLE|M3_NOPOLY,
	HI_DOMESTIC),
    MON("Woodland-elf", S_HUMAN,
	LVL(5, 12, 10, 10, -5), (G_GENO|G_SGROUP|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	...
	LVL(6, 12, 10, 10, -6), (G_GENO|G_SGROUP|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	...
	LVL(7, 12, 10, 10, -7), (G_GENO|G_SGROUP|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_PEACEFUL|M2_STRONG|M2_COLLECT|M2_MAGIC,
	M3_INFRAVISIBLE|M3_NOPOLY, HI_DOMESTIC),
    MON("guard", S_HUMAN,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_MERC|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_BLUE),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_CLOSE|M3_NOPOLY, HI_DOMESTIC),
    MON("Oracle", S_HUMAN,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_PEACEFUL|M2_FEMALE, M3_INFRAVISIBLE|M3_NOPOLY, HI_ZAP),
	...
	M2_HUMAN|M2_ELF|M2_LORD|M2_PEACEFUL|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_WHITE),
	...
	M2_HUMAN|M2_ELF|M2_MINION|M2_PRINCE|M2_NASTY|M2_COLLECT
	|M2_MAGIC, M3_WANTSAMUL|M3_INFRAVISIBLE|M3_NOPOLY, CLR_WHITE),
    MON("soldier", S_HUMAN,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_MERC|M2_STALK|M2_HOSTILE|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_GRAY),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_MERC|M2_STALK|M2_HOSTILE|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_RED),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_MERC|M2_STALK|M2_HOSTILE|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_GREEN),
    MON("captain", S_HUMAN,
	...
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_RACEMASK|M2_MERC|M2_STALK|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_NOPOLY, CLR_GRAY),
	...
	M2_HOSTILE|M2_STRONG|M2_PNAME|M2_FEMALE,
	M3_WAITFORU|M3_INFRAVISIBLE|M3_NOPOLY, CLR_BRIGHT_GREEN),
	...
	M2_HUMAN|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_PRINCE|M2_MALE|M2_MAGIC,
	M3_COVETOUS|M3_WAITFORU|M3_INFRAVISIBLE|M3_NOPOLY, HI_LORD),
    MON("Croesus", S_HUMAN,
	...
	M1_HUMANOID|M1_SEE_INVIS|M1_OMNIVORE,
	M2_HUMAN|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_PNAME|
	  M2_PRINCE|M2_MALE|M2_GREEDY|M2_JEWELS|M2_COLLECT|M2_MAGIC,
	M3_INFRAVISIBLE|M3_NOPOLY, HI_LORD),
#ifdef CHARON
    MON("Charon", S_HUMAN,
 ...
 */
	...
	M2_UNDEAD|M2_STALK|M2_HOSTILE, M3_INFRAVISION|M3_NOPOLY, CLR_GRAY),
    MON("shade", S_GHOST,
	...
	M2_UNDEAD|M2_WANDER|M2_STALK|M2_HOSTILE|M2_NASTY,
	M3_INFRAVISION|M3_NOPOLY, CLR_BLACK),
/*
 * (major) demons
 */
	...
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, CLR_BLUE),
...
#undef SEDUCTION_ATTACKS
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_LORD|
	  M2_MALE,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISION|M3_NOPOLY, CLR_BRIGHT_GREEN),
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_LORD|
	  M2_MALE|M2_COLLECT,
	M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, HI_LORD),
    MON("Orcus", S_DEMON,
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY| M2_PRINCE|M2_MALE,
	M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, HI_LORD),
	...
	M3_NOPOLY|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
	...
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY| M2_PRINCE|M2_MALE,
	M3_NOPOLY|M3_WANTSAMUL|M3_WAITFORU|M3_INFRAVISIBLE|M3_INFRAVISION,
	HI_LORD),
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|
	...
	M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY,
	M3_NOPOLY|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
	...
	M2_STALK|M2_PEACEFUL, M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY,
	CLR_BRIGHT_BLUE),
#endif
    MON("djinni", S_DEMON,
	...
	M1_HUMANOID|M1_FLY|M1_POIS,
	M2_STALK|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE, CLR_YELLOW),
    MON("sandestin", S_DEMON,
	LVL(13, 12, 4, 60, -5), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 400, 0, MS_CUSS, MZ_HUMAN), MR_STONE, 0,
	M1_HUMANOID, M2_STALK|M2_STRONG|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_NOPOLY, CLR_GRAY),
/*
 * sea monsters
 */
    MON("jellyfish", S_EEL,
	...
	M2_HOSTILE|M2_STRONG, M3_NOPOLY|M3_INFRAVISIBLE, CLR_RED),
/*
 * lizards, &c
 */
    MON("newt", S_LIZARD,
	...
	M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE, M2_HOSTILE, M3_NOPOLY, CLR_BROWN),
 ...
 */
	...
	M2_HUMAN|M2_DWARF|M2_GNOME|M2_STRONG|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ORC|M2_STRONG|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE,
	HI_DOMESTIC),
    MON("caveman", S_HUMAN,
	LVL(10, 12, 10, 0, 1), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_GNOME|M2_STRONG|M2_MALE|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_GNOME|M2_STRONG|M2_FEMALE|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("healer", S_HUMAN,
	LVL(10, 12, 10, 1, 0), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_GNOME|M2_STRONG|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE,
	HI_DOMESTIC),
    MON("knight", S_HUMAN,
	LVL(10, 12, 10, 1, 3), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_STRONG|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("monk", S_HUMAN, 
	LVL(10, 12, 10, 2, 0), (1),
	...
	M2_HUMAN|M2_STRONG|M2_COLLECT|M2_MALE,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("priest", S_HUMAN,
	LVL(10, 12, 10, 2, 0), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_STRONG|M2_MALE|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE,
	HI_DOMESTIC),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_STRONG|M2_FEMALE|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("ranger", S_HUMAN,
	LVL(10, 12, 10, 2, -3), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_GNOME|M2_ORC|M2_STRONG|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("rogue", S_HUMAN,
	LVL(10, 12, 10, 1, -3), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ORC|M2_STRONG|M2_GREEDY|M2_JEWELS|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("samurai", S_HUMAN,
	LVL(10, 12, 10, 1, 3), (1),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_STRONG|M2_FEMALE|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("wizard", S_HUMAN,
	LVL(10, 12, 10, 3, 0), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  ATTK(AT_MAGC, AD_SPEL, 6, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_GNOME|M2_ORC|M2_STRONG|M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_INFRAVISIBLE,
	HI_DOMESTIC),
/*
 ...
 */
	...
	A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(0, 0, 0, 0, 0), 0, 0, 0L, 0L, M3_NOPOLY, CLR_BROWN),
 ...
 */
	...
	M1_TUNNEL|M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_PNAME|M2_PEACEFUL|M2_STRONG|M2_MALE|
	  M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISIBLE, HI_LORD),
    MON("Pelias", S_HUMAN,
	...
	M1_HUMANOID|M1_SEE_INVIS|M1_OMNIVORE,
	M2_ELF|M2_HUMAN|M2_PNAME|M2_PEACEFUL|M2_STRONG|
	  M2_MALE|M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISION|M3_INFRAVISIBLE, HI_LORD),
    MON("Elwing", S_HUMAN,
	LVL(20, 12, 0, 50, -20), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_NASTY|M2_MAGIC,
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISIBLE, CLR_BLACK),
	...
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISIBLE, CLR_WHITE),
    MON("Orion", S_HUMAN,
	LVL(20, 12, 0, 30, 0), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_MALE|M2_GREEDY|
	...
	M2_HUMAN|M2_PNAME|M2_PEACEFUL|M2_STRONG|M2_MALE|
	  M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISIBLE, HI_DOMESTIC),
#endif
    MON("Norn", S_HUMAN,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_FEMALE|
	  M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISIBLE, HI_LORD),
	...
	SIZ(WT_HUMAN, 400, 0, MS_LEADER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_FEMALE|M2_PNAME|M2_PEACEFUL|
	  M2_STRONG|M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_CLOSE|M3_INFRAVISIBLE, CLR_GREEN),
/*
 * quest nemeses
 */
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISION|M3_INFRAVISIBLE,
	CLR_RED),
	...
	M1_HUMANOID|M1_OMNIVORE|M1_TPORT|M1_TPORT_CNTRL,
	M2_HUMAN|M2_PNAME|M2_STRONG|M2_MALE|M2_STALK|M2_HOSTILE|
	  M2_NASTY|M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISIBLE, HI_LORD),
	...
	M2_HOSTILE|M2_FEMALE|M2_STALK|M2_STRONG|M2_NASTY|
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_ORC|M2_HOSTILE|M2_STRONG|M2_STALK|M2_NASTY|M2_MALE|
	  M2_GREEDY|M2_JEWELS|M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISION|M3_INFRAVISIBLE, HI_LORD),
#endif
    MON("Cyclops", S_GIANT,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_GIANT|M2_STRONG|M2_ROCKTHROW|M2_STALK|M2_HOSTILE|
	...
	M2_PNAME|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_STALK|
	  M2_GREEDY|M2_JEWELS|M2_MAGIC,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISIBLE, CLR_RED),
	...
	SIZ(WT_HUMAN, 400, 0, MS_NEMESIS, MZ_LARGE),
	MR_FIRE|MR_POISON|MR_STONE, 0, M1_FLY|M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_PNAME|M2_HOSTILE|M2_STRONG|M2_STALK|
	  M2_NASTY|M2_COLLECT,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISION|M3_INFRAVISIBLE,
	CLR_RED),
	...
	M1_ANIMAL|M1_NOHANDS|M1_OVIPAROUS|M1_POIS|M1_CARNIVORE,
	M2_PNAME|M2_HOSTILE|M2_STRONG|M2_STALK|M2_NASTY|
	  M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU, HI_LORD),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_STRONG|M2_HOSTILE|M2_STALK|M2_NASTY|
	  M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISIBLE, HI_LORD),
	...
	SIZ(WT_HUMAN, 400, 0, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_PNAME|M2_HOSTILE|M2_STRONG|M2_STALK|
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_GIANT|M2_MALE|M2_PNAME|M2_HOSTILE|M2_STALK|
	...
	SIZ(WT_HUMAN, 400, 0, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
	M1_HUMANOID|M1_OMNIVORE|M1_TPORT|M1_TPORT_CNTRL,
	M2_HUMAN|M2_STRONG|M2_HOSTILE|M2_STALK|M2_NASTY|M2_COLLECT|M2_MAGIC,
	M3_NOPOLY|M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISIBLE, CLR_BLACK),
/*
 * quest "guardians"
 */
    MON("student", S_HUMAN,
	...
	M1_TUNNEL|M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_GNOME|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ORC|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
	...
	M1_HUMANOID|M1_SEE_INVIS|M1_OMNIVORE,
	M2_ELF|M2_PEACEFUL|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISION|M3_INFRAVISIBLE, HI_DOMESTIC),
#endif
	...
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), MR_POISON, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_GNOME|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("page", S_HUMAN,
	LVL(5, 12, 10, 10, 3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
	...
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE,
	HI_DOMESTIC),
    MON("abbot", S_HUMAN, 
	...
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_PEACEFUL|M2_STRONG|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("hunter", S_HUMAN,
	LVL(5, 12, 10, 10, -7), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
	...
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_SEE_INVIS|M1_OMNIVORE,
	M2_HUMAN|M2_ELF|M2_GNOME|M2_ORC|M2_PEACEFUL|M2_STRONG
	|M2_COLLECT, M3_NOPOLY|M3_INFRAVISION|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("thug", S_HUMAN,
	LVL(5, 12, 10, 10, -3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_ORC|M2_PEACEFUL|M2_STRONG|M2_GREEDY|M2_COLLECT,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("ninja", S_HUMAN,
	LVL(5, 12, 10, 10, 3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_HOSTILE|M2_STRONG|M2_COLLECT, M3_NOPOLY|M3_INFRAVISIBLE,
	HI_DOMESTIC),
    MON("roshi", S_HUMAN,
	LVL(5, 12, 10, 10, 3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
	...
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_DWARF|M2_PEACEFUL|M2_STRONG|M2_COLLECT|M2_FEMALE,
	M3_NOPOLY|M3_INFRAVISIBLE, HI_DOMESTIC),
