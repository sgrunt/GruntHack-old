...
WEAPON("butterknife", (char *)0,
	1, 1, 0,  0,  5,  1,  1,  1, 0, P|S, P_KNIFE, IRON, HI_METAL),
...
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	79, 5, 450, 600,  3, 2, ARM_SUIT, IRON, HI_METAL),
#else
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	89, 5, 450, 600,  3, 2, ARM_SUIT, IRON, HI_METAL),
#endif
...
ARMOR("dwarvish chain mail", (char *)0,
	1, 0, 0, 0,	10, 1, 300,  75,  4, 3, ARM_SUIT, IRON, HI_METAL),
ARMOR("elven chain mail", (char *)0,
	1, 0, 0, 0,	15, 1, 300,  75,  5, 3, ARM_SUIT, COPPER, HI_METAL),
...
CLOAK("cloak", (char *)0,
		1, 0,	0,	    8, 0, 15, 40,  9, 1, CLOTH, HI_CLOTH),
/* With shuffled appearances... */
...
TOOL("blindfold", (char *)0,    1, 0, 0, 0,  45,  2,  20, CLOTH, CLR_BLACK),
...
TOOL("felt marker", "marker",   0, 0, 0, 1,  20,  2,  10, PLASTIC, CLR_RED),
TOOL("magic marker", "marker",  0, 0, 1, 1,  10,  2,  50, PLASTIC, CLR_RED),
/* traps */
...
SPELL("dig",             "parchment",   P_MATTER_SPELL, 15,  6, 5, 1, RAY,       HI_PAPER),
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 45,  2, 2, 1, RAY,       HI_PAPER),
SPELL("fireball",        "ragged",      P_ATTACK_SPELL, 16,  4, 4, 1, RAY,       HI_PAPER),
SPELL("cone of cold",    "dog eared",   P_ATTACK_SPELL, 10,  7, 4, 1, RAY,       HI_PAPER),
SPELL("sleep",           "mottled",     P_ENCHANTMENT_SPELL, 45,  1, 1, 1, RAY,       HI_PAPER),
...
SPELL("poison blast",	 "olive green", P_ATTACK_SPELL, 8, 9, 5, 1, RAY,	CLR_GREEN),
SPELL("acid blast",	 "acid green",  P_ATTACK_SPELL, 8, 9, 6, 1, RAY,	CLR_BRIGHT_GREEN), 
SPELL("touch of death",	 "crimson",	P_ATTACK_SPELL, 5, 8, 5, 1, IMMEDIATE,	 CLR_RED),
SPELL("light",           "cloth",       P_DIVINATION_SPELL, 40,  1, 1, 1, NODIR,     HI_CLOTH),
SPELL("detect monsters", "leather-bound",     P_DIVINATION_SPELL, 35,  1, 1, 1, NODIR,     HI_LEATHER),
...
SPELL("psi bolt",        "maroon",      P_ATTACK_SPELL, 30,  2, 1, 1, IMMEDIATE, CLR_RED),
...
SPELL("slow monster",    "light green", P_ENCHANTMENT_SPELL, 23,  2, 2, 1, IMMEDIATE, CLR_BRIGHT_GREEN),
SPELL("wizard lock",     "dark green",  P_MATTER_SPELL, 23,  3, 2, 1, IMMEDIATE, CLR_GREEN),
SPELL("create monster",  "turquoise",   P_CLERIC_SPELL, 28,  3, 2, 1, NODIR,     CLR_BRIGHT_CYAN),
SPELL("detect food",     "cyan",        P_DIVINATION_SPELL, 25,  3, 2, 1, NODIR,     CLR_CYAN),
SPELL("cause fear",      "light blue",  P_ENCHANTMENT_SPELL, 23,  3, 3, 1, NODIR,     CLR_BRIGHT_BLUE),
SPELL("clairvoyance",    "dark blue",   P_DIVINATION_SPELL, 15,  3, 3, 1, NODIR,     CLR_BLUE),
SPELL("cure sickness",   "indigo",      P_HEALING_SPELL, 35,  3, 3, 1, NODIR,     CLR_BLUE),
SPELL("charm monster",   "magenta",     P_ENCHANTMENT_SPELL, 18,  3, 3, 1, IMMEDIATE, CLR_MAGENTA),
SPELL("cause aggravation", "blood red", P_ENCHANTMENT_SPELL, 10, 5, 4, 1, IMMEDIATE, CLR_RED),
SPELL("haste self",      "purple",      P_ESCAPE_SPELL, 25,  4, 3, 1, NODIR,     CLR_MAGENTA),
...
SPELL("magic mapping",   "dusty",       P_DIVINATION_SPELL, 20,  7, 5, 1, NODIR,     HI_PAPER),
...
SPELL("cancellation",    "shining",     P_MATTER_SPELL, 10,  8, 7, 1, IMMEDIATE, CLR_WHITE),
...
SPELL("flame sphere",    "canvas",      P_MATTER_SPELL, 10,  2, 1, 1, NODIR, CLR_BROWN),
SPELL("freeze sphere",   "hardcover",   P_MATTER_SPELL, 10,  2, 1, 1, NODIR, CLR_BROWN),
SPELL("shock sphere",    "hide-bound",        P_MATTER_SPELL, 10,  2, 1, 1, NODIR, CLR_BROWN),
